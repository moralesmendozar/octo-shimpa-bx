...
###################### Funciones para el multicore processing:
...
############### Fin de definción de funciones para el multicore processing
...
def graficar(dic):
    ...
    for d in dist:
        ...
        colors = [(0,0,0),(0.5,0.5,0.5),(0.5,0.5,1),(0.5,1,0.5),(0.5,1,1),(1,0.5,0.5),(1,0.5,1),(1,1,0.5),(1,1,1)]
