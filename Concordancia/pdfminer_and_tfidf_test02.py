...
#Hacemos el tfidf para inglés
tfidf_setting_en = TfidfVectorizer(encoding='utf-8', strip_accents='unicode',
                                analyzer='word', lowercase = True, stop_words = stop_words_english,
                                use_idf = True, min_df=0)

print 'getting tfidf_matrix() ...'                            
tfidf_matrix = tfidf_setting.fit_transform(docs_collection)
print 'getting tfidf_matrix_en() ...'
tfidf_matrix_en = tfidf_setting.fit_transform(docs_collection)
...
print ''
print tfidf_matrix
############ Imprime las palabras importantes que :
...
#print response
print "-------------------------------------------------------------"
print 'this is the most important terms:'
